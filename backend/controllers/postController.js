  ...
  try {
    ...
    if (image && image.startsWith('data:image')) {
      try {
        ...
        console.warn('⚠️ Cloudinary Upload Failed. Falling back to default cover image.', cloudinaryError.message);
  ...
  try {
    ...
    if (image && image.startsWith('data:image')) {
      try {
        ...
        console.warn('⚠️ Cloudinary Upload Failed. Falling back to original or placeholder cover.', cloudinaryError.message);
        imageUrl = post.image || 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=800&auto=format&fit=crop&q=60';
      }
    }
