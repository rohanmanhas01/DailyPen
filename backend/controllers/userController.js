  ...
  try {
    ...
    if (avatar && avatar.startsWith('data:image')) {
      try {
        ...
        console.warn('⚠️ Cloudinary Avatar Upload Failed. Falling back to default UI avatar.', cloudinaryError.message);
        avatarUrl = user.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(name || user.name)}&background=random`;
      }
    }
